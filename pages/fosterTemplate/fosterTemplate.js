...
Page({
  ...
  getDayList(year, month) {
    ...
    dayList.forEach(Ditem => {
      ...
      // console.log(dates)
      // this.data.activeList.forEach(Aitem => {
      //   // console.log(dates, Aitem)
