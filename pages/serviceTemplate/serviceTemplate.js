...
Page({
  ...
  onLoad: function(options) {
    console.log(options)
    // console.log(options.selectiontime)
    this.getDates()
    //初始化数据
    // this.initialization()
    // 选择宠物
    ...
    this.setData({
      ...
      // selectiontime: Number(options.selectiontime)
    })
    // 判断是不是改签过来的页面
    if (options.isrebook) {
      this.setData({
  ...
  goorder(e) {
    ...
    if (!this.data.selectDate) {
      ...
      if (this.data.setmeal[this.data.indexI].price){
        wx.navigateTo({
          url: '/pages/order/order?price=' + this.data.setmeal[this.data.indexI].price + '&service_id=' + this.data.service_id + '&name=' + this.data.pet_list[this.data.index].name + '&specs=' + this.data.pet_list[this.data.index].specs + '&weight=' + this.data.pet_list[this.data.index].weight + '&time=' + this.data.selectDate + '&member_pets_id=' + this.data.pet_list[this.data.index].id + '&service_specs_id=' + this.data.setmeal[this.data.indexI].specs_id + '&date_time=' + this.data.selectDate + '&mername=' + this.data.mername + '&exes=' + ['bath/expenses', 'bath/add', 'bath/store'] + '&service_product_id=' + this.data.setmeal[this.data.indexI].id + '&is_distribution=' + this.data.is_distribution + '&shop_id=' + this.data.setmeal[this.data.indexI].shop_id
        })
      }
