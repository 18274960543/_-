...
// 完善信息同意协议切换
  ...
  showerData(pets_id,name) {
    ...
    // console.log(pets_id)
    wx.request({
      url: url.api + `/ucs/v1/service/bath/info`, // 仅为示例，并非真实的接口地址
      data: {
      ...
      success: (res) => {
        ...
        // console.log(this.data.delicate)
      }
    })
  },
  // 添加宠物
